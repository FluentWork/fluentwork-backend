...
func setupServer(t *testing.T) (*httpserver.Server, *account.Service) {
	...
	server := httpserver.New(cfg, logger, accountHandler, nil, nil, sessionHandler, nil, nil, nil, nil, nil, accountStore.Ping)
...
func setupServerWithReviewGen(t *testing.T, gen session.ReviewGenerator) (*httpserver.Server, *session.Service) {
	...
	sessionHandler := session.NewHandler(sessionSvc, accountHandler)
	return httpserver.New(cfg, logger, accountHandler, nil, nil, sessionHandler, nil, nil, nil, nil, nil, accountStore.Ping), sessionSvc
}
