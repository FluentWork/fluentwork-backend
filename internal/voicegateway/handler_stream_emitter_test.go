...
func (p *emitterTrackingProvider) Open(context.Context, voicegateway.ConsumedTicket, *voicegateway.SeqAllocator, *voicegateway.TurnRefAllocator) (voicegateway.VoiceProviderSession, error) {
